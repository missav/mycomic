                        ...
                        @if (\Illuminate\Support\Str::length($comic->description()) > 150)
                            <div x-data="{ show: false }">
                                <div x-show="! show">
                                    ...
                                    <a href="#" @click.prevent="show = ! show" class="text-orange-700 dark:text-amber-500 hover:underline underline-offset-4">
                                        {{ __('Show all') }}
                                    </a>
                                </div>
                ...
                <div class="mt-3 flex items-center">
                    ...
                    <p class="text-sm text-gray-500 dark:text-white/80">
                        ...
                        @if ($reviews->isNotEmpty())
                            [<a href="#" @click.prevent="$dispatch('modal-show', { name: 'text-reviews' })" class="text-orange-700 dark:text-amber-500 hover:underline underline-offset-4">{{ __('Detail') }}</a>]
                        @endif
                    </p>
                </div>
                <div class="mt-6">
