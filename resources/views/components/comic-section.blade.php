...
<div {{ $attributes->merge(['class' => 'grid grid-cols-2 gap-x-6 gap-y-10 sm:grid-cols-3 lg:grid-cols-6 xl:gap-x-8']) }}>
    <template x-for="comic in comics">
        <div class="group relative">
            <div class="lozad aspect-w-5 aspect-h-3 sm:aspect-w-1 sm:aspect-h-1 lg:aspect-w-3 lg:aspect-h-4 w-full overflow-hidden rounded-md bg-gray-200 group-hover:opacity-75">
