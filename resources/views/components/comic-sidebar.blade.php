<flux:navlist {{ $attributes->merge(['class' => 'w-32 lg:w-40 mr-6 lg:mr-8 space-y-4']) }}>
    @if (request()->has('filter'))
        <flux:button size="sm" :href="localizedRoute('comics.index', request()->append('filter', null))">
            {{ __('Reset filters') }}
        </flux:button>
    @endif
    {{ $slot }}
    <flux:navlist.group heading="{{ __('Region') }}" expandable>
        <flux:navlist.item
            :href="localizedRoute('comics.index', request()->append('filter.country', null))"
        ...
        @foreach (\App\Enums\ComicCountry::cases() as $comicCountry)
            <flux:navlist.item
                :href="localizedRoute('comics.index', request()->append('filter.country', $comicCountry->value))"
    ...
    <flux:navlist.group heading="{{ __('Genre') }}" expandable :expanded="request()->has('filter.tag')">
        <flux:navlist.item
            :href="localizedRoute('comics.index', request()->append('filter.tag', null))"
        ...
        @foreach (\App\Models\Tag::cached() as $slug => $name)
            <flux:navlist.item
                :href="localizedRoute('comics.index', request()->append('filter.tag', $slug))"
    ...
    <flux:navlist.group heading="{{ __('Audience') }}" expandable :expanded="request()->has('filter.audience')">
        <flux:navlist.item
            :href="localizedRoute('comics.index', request()->append('filter.audience', null))"
        ...
        @foreach (\App\Enums\ComicAudience::cases() as $comicAudience)
            <flux:navlist.item
                :href="localizedRoute('comics.index', request()->append('filter.audience', $comicAudience->value))"
    ...
    <flux:navlist.group heading="{{ __('Year') }}" expandable :expanded="request()->has('filter.year')">
        <flux:navlist.item
            :href="localizedRoute('comics.index', request()->append('filter.year', null))"
        ...
        @foreach (array_merge(range(now()->year, 2010), ['200x', '199x', '198x', '197x']) as $year)
            <flux:navlist.item
                :href="localizedRoute('comics.index', request()->append('filter.year', $year))"
    ...
    <flux:navlist.group heading="{{ __('Progress') }}" expandable :expanded="request()->has('filter.end')">
        <flux:navlist.item
            :href="localizedRoute('comics.index', request()->append('filter.end', null))"
        ...
        <flux:navlist.item
            :href="localizedRoute('comics.index', request()->append('filter.end', '0'))"
        ...
        <flux:navlist.item
            :href="localizedRoute('comics.index', request()->append('filter.end', '1'))"
