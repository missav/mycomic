<x-layout>
    <div class="md:flex">
        ...
        <div class="grow">
            ...
            @if (request('q'))
                <a href="{{ localizedRoute('comics.index', request()->append('q', null)) }}">
            ...
            @elseif (request('filter.author'))
                <a href="{{ localizedRoute('comics.index', request()->append('filter.author', null)) }}">
                    <flux:badge class="mb-6" size="lg" color="amber">
            ...
            @endif
            <x-comic-thumbnails :comics="$comics" preload="1" class="mb-12"></x-comic-thumbnails>
            <div>
                {{ $comics->links() }}
            </div>
        </div>
